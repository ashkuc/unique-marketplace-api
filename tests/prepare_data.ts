...
const genOffer = (id, {
  creationDate=null, collectionId=1, tokenId=1, price='0000000000000000000000000000100000000000',
  seller='jq8EFRaHc2Mmyf6hfiX8UodhNpPJEpCcsiaqR5Tyakg=', sellerPublicKeyBytes="E'\\\\x8EAF04151687736326C9FEA17E25FC5287613693C912909CB226AA4794F26A48'",
  offerStatus=1, quoteId=2, metadata=null
}) => {
  ...
  return {
    id, creationDate, collectionId, tokenId, price, seller, offerStatus, sellerPublicKeyBytes, quoteId, metadata
  }
}
...
export const prepareTradesData = async queryBuilder => {
  await queryBuilder.insert().values([
    genOffer("1b670fde-fa17-4a56-ab51-3af1a9ac893a", {
      collectionId: 1, tokenId: 2, price: '0000000000000000000000000000300000000000', offerStatus: 3, creationDate: '2021-01-01 00:00:00'
    }),
    genOffer("3f1a6051-a162-41ad-8266-52568265c4df", {
      collectionId: 3, tokenId: 1, price: '0000000000000000000000000000100000000000', offerStatus: 3, creationDate: '2021-01-02 00:00:00'
    }),
    genOffer("87c3a642-a194-42d3-a5f1-1c702dd294fe", {
      collectionId: 2, tokenId: 3, price: '0000000000000000000000000000200000000000', offerStatus: 3, creationDate: '2021-01-03 00:00:00'
    })
  ]).into(Offer).execute();
...
export const prepareSearchData = async queryBuilder => {
  await queryBuilder.insert().values([
    genOffer("1b670fde-fa17-4a56-ab51-3af1a9ac893a", {
      collectionId: 23, tokenId: 120, creationDate: '2021-01-03 00:00:00'
    }),
    genOffer("3f1a6051-a162-41ad-8266-52568265c4df", {
      collectionId: 23, tokenId: 12, creationDate: '2021-01-01 00:00:00'
    }),
    genOffer("87c3a642-a194-42d3-a5f1-1c702dd294fe", {
      collectionId: 23, tokenId: 42, creationDate: '2021-01-02 00:00:00'
    })
  ]).into(Offer).execute();
  await queryBuilder.insert().values([
